...
\title{Entropic Hyper-Connectomes Computation and Analysis\thanks{Submitted to the editors March 8, 2022.}}
...
Proof in supplemental. With the justification of \cref{thm}, we will approximate the total correlation from finite samples with \cref{alg:buildtree}. 
